...
\midrule
Claude & Commercial only & Unclassified use only; do not input PII or CUI \\
\midrule
...
\midrule
Claude & Web access at claude.ai (commercial only, unclassified) & Not on GenAI.mil; strong for complex reasoning and documentation \\
\midrule
