...
EDD tools handle data at varying classification levels depending on the platform.
The following data handling restrictions apply:

\calloutbox{Prohibited Data}{%
\begin{itemize}
  \item Classified information (any level) except on IL6/SIPR-authorized tools (currently CamoGPT only)
  \item Controlled Unclassified Information (CUI) on platforms not authorized for CUI (use GenAI.mil or CamoGPT for CUI)
  \item Personally Identifiable Information (PII) unless a Privacy Impact Assessment has been completed
  \item Protected Health Information (PHI) unless a completed PIA authorizes it
  \item Operational plans, force movement data, or operational intelligence products
\end{itemize}}
...
\bottomrule
\endlastfoot
GenAI.mil & DoD-authorized (IL5) & Marine Corps enterprise primary per MARADMIN 018/26; models include Gemini, Grok, ChatGPT; CUI-authorized (PII requires PIA); supports file upload, RAG, deep research, web grounding \\
\midrule
CamoGPT & DoD-authorized (IL5/IL6) & Army-managed; available on NIPR (IL5) and SIPR (IL6); API access, tool calling, shared workspaces, file upload; CUI-authorized \\
\midrule
...
\midrule
Gemini & Available via GenAI.mil; also commercial & IL5 via GenAI.mil (CUI-authorized); commercial instance (gemini.google.com) is unclassified only \\
\midrule
ChatGPT & Available via GenAI.mil; also commercial & IL5 via GenAI.mil (CUI-authorized); commercial instance (chatgpt.com) is unclassified only \\
\midrule
C3 AI & Enterprise-authorized & DoW Enterprise AI platform; available through enterprise agreement \\
\end{longtable}

\textbf{Note:} Per MARADMIN 018/26 (January 2026), GenAI.mil is designated as the Marine Corps enterprise generative AI platform. It launched in December 2025, replaces the Air Force's NIPRGPT (sunsetted), and serves over 1.1 million unique users across five military branches.

GenAI.mil provides file upload, retrieval-augmented generation (RAG), deep research, document formatting, video and imagery analysis, web grounding, and persistent chat histories. CamoGPT provides API access, tool calling, shared workspaces, file upload, and is the only listed tool with classified network (IL6/SIPR) access.

\textbf{Data Handling Boundaries:} CUI may be processed on IL5-authorized platforms (GenAI.mil, CamoGPT). PII and PHI must be anonymized before use on any AI platform unless a completed Privacy Impact Assessment (PIA) authorizes it. Classified information must never be input to any AI tool except those operating on IL6/SIPR (currently CamoGPT only). When accessed outside GenAI.mil, commercial AI tools (chatgpt.com, gemini.google.com) are authorized for unclassified, non-sensitive data only.
...
\bottomrule
\endlastfoot
GenAI.mil & Enterprise AI chat, file analysis, deep research, code generation & DoD-authorized IL5; CAC authentication; enterprise primary per MARADMIN 018/26 \\
\midrule
CamoGPT & AI chat, API access, tool calling, SIPR AI access & Army-managed; IL5 (NIPR) and IL6 (SIPR); CAC authentication \\
\midrule
...
\bottomrule
\endlastfoot
GenAI.mil & CAC-authenticated at genai.mil; no separate account required; requires DoD network & Start here --- this is the Marine Corps enterprise primary per MARADMIN 018/26 \\
\midrule
CamoGPT & CAC-authenticated at camogpt.mil; requires DoD network & Use for API access, tool calling, or SIPR tasks; supplementary to GenAI.mil \\
\midrule
...
\midrule
Gemini & CAC-authenticated via GenAI.mil (CUI-authorized); also at gemini.google.com (unclassified only) & Available on GenAI.mil and commercially \\
\midrule
ChatGPT & CAC-authenticated via GenAI.mil (CUI-authorized); also at chatgpt.com (unclassified only) & Available on GenAI.mil and commercially \\
\midrule
...
not be the same person who built the tool. Before deployment, confirm alignment
with the CDAO GenAI RAI Toolkit (Version 1.0, December 2024) assessment questions.
...
\begin{itemize}
  ...
  \item Executive Order 14179---Removing Barriers to American Leadership in Artificial Intelligence (January 2025)
...
\midrule
PIA Threshold Analysis & Phase 2: Compliance Review & pia-threshold-analysis.md \\
\midrule
Compliance Checklist & Phase 2: Compliance Review & compliance-checklist.md \\
\end{longtable}
...
\begin{longtable}{@{}p{0.6cm}p{7.6cm}p{1.9cm}p{3cm}@{}}
\toprule
...
\midrule
8 & Alignment confirmed with CDAO GenAI RAI Toolkit assessment questions & & \\
\midrule
\multicolumn{4}{l}{\textbf{Documentation}} \\
\midrule
9 & Documentation package is complete & & \\
\midrule
10 & A new person could maintain the tool using only the documentation & & \\
\midrule
11 & User guide is clear and accurate & & \\
\midrule
12 & Technical documentation describes architecture and dependencies & & \\
\midrule
\multicolumn{4}{l}{\textbf{Deployment Readiness}} \\
\midrule
13 & Tool is deployed on an approved platform & & \\
\midrule
14 & Sustainment plan identifies a maintainer & & \\
\midrule
15 & Tool Registry entry is complete & & \\
\midrule
\multicolumn{4}{l}{} \\
\midrule
...
\begin{longtable}{@{}p{0.6cm}p{8.9cm}p{1.3cm}p{2.5cm}@{}}
\toprule
