...
The v4.0 curriculum restructured training around six 201-level skills. That was the right move. But it crammed two different audiences into the same opening course: people who need to \textit{use} AI effectively and people who want to \textit{build} tools with AI. Those are different training objectives for different populations.
...
\textbf{Design implication:} Frontier Recognition is a core 201 skill, not a footnote. We teach students to identify the boundary and share failure cases. The centaur/cyborg framework gives students a vocabulary for choosing how to work with AI on different task types.
...
\textbf{Design implication:} AI doesn't replace expertise --- it amplifies it. But it amplifies judgment \textit{and} errors equally. This is why Quality Judgment is the most important 201 skill: the same tool that makes a junior Marine more productive also makes an overconfident one more dangerous.
...
% =============================================================================
\section{The Six 201-Level Skills}
...
\toprule
\textbf{\#} & \textbf{Skill} & \textbf{What It Means} & \textbf{101 Behavior} & \textbf{201 Behavior} \\
\midrule
\endhead
\bottomrule
\endfoot
...
\bottomrule
\endfoot
\textbf{AI Fluency Fundamentals} & 2 hours & All personnel & None & Understand the six 201 skills, recognize the jagged frontier, know when to trust AI output, map AI into your workflow \\
\midrule
...
\toprule
\textbf{Time} & \textbf{Module} & \textbf{201 Skills Targeted} \\
\midrule
\endhead
\bottomrule
\endfoot
...
\begin{itemize}[nosep]
  ...
  \item 201: ``Write a counseling statement for a Lance Corporal who was late to formation twice this month. The tone should be corrective but not adversarial. The Marine has otherwise been a solid performer. Use the format from NAVMC 10274. This is a page 11 entry, not an adverse 6105.''
\end{itemize}
...
\begin{itemize}[nosep]
  ...
  \item 201: Break it into subtasks. ``First, list the required annual training events for FY26. Then map them against the calendar, avoiding known conflicts. Then identify which events need range time and put those first.''
\end{itemize}
...
\textbf{Purpose:} For people who want to go beyond daily AI use and actually build tools. Focuses entirely on hands-on building. The 201 framework was covered in AI Fluency Fundamentals --- here we apply it.
...
\begin{longtable}{L{0.8in} L{2.8in} L{2in}}
\toprule
\textbf{Time} & \textbf{Module} & \textbf{201 Skills Applied} \\
\midrule
\endhead
\bottomrule
\endfoot
...
\textbf{Instructor note:} Quickly verify that all students completed AI Fluency Fundamentals. Ask: ``What are the six 201 skills?'' If students can't recall at least four, do a 2-minute refresher. Then move on.
...
% ---------------------------------------------------------------------------
\subsection{Module 5: Teaching Others --- The 201 Multiplier (30 min)}
...
\textbf{The six 201 skills} (headline level only): Context Assembly, Quality Judgment, Task Decomposition, Iterative Refinement, Workflow Integration, Frontier Recognition. These are management skills, not technical skills. Your Marines already have the foundation.
...
% =============================================================================
\section{Appendix B: Quick Reference --- The Six 201 Skills}
