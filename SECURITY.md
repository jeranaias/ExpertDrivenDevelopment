...
**All materials in this repository are UNCLASSIFIED and approved for public release.**

This repository contains open-source training materials for Department of War (DoW) personnel on AI-assisted development methodologies. Every file, document, code sample, and example within this repository must be and remain UNCLASSIFIED at all times.
...
1. **Do not share or distribute** the affected content further.
2. **Open an issue** in this repository with the title: `[SECURITY] Potential Sensitive Data Exposure` -- do **not** include the sensitive data itself in the issue.
3. **Contact the project point of contact directly:**
...
4. If the POC is unavailable, contact your local cybersecurity office.
5. The repository maintainers will take immediate action to remove the content from the repository and its history.

## DoW Open Source Policy Reference
